...
`dots` installs a minimal Wayland desktop with Hyprland, Waybar, Wofi, Mako, Alacritty, tmux, shared theme colors, and developer-friendly defaults. It is inspired by projects like Omarchy, but smaller, more personal, and focused on my preferred workflow.
...
- Edit shared colors in `themes/<name>/colors.toml`.
